...
#endif
  connect(&moProcessPublisher,SIGNAL(finished(int, QProcess::ExitStatus)),this,SLOT(finishedPub(int, QProcess::ExitStatus)));
  connect(&moProcessSubscriberFast,SIGNAL(finished(int, QProcess::ExitStatus)),this,SLOT(finishedSubFast(int, QProcess::ExitStatus)));
  connect(&moProcessSubscriberSlow,SIGNAL(finished(int, QProcess::ExitStatus)),this,SLOT(finishedSubSlow(int, QProcess::ExitStatus)));
